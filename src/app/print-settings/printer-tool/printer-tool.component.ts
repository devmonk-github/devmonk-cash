...
export class PrinterToolComponent implements OnInit {
  ...
  async save() {
    ...
    const printRawContentResult: any = await this.printService.printRawContent(this.iBusinessId, this.zplCode, this.labelPrintSettings?.nPrinterId, this.labelPrintSettings?.nComputerId, 1, { title: 'Print label' }, this.businessDetails.oPrintNode.sApiKey)
