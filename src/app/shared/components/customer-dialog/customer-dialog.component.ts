        ...
        this.isCustomerSearched = true;
          if (result && result.data && result.data[0] && result.data[0].result) {
            ...
            for(const customer of this.customers){
              ...
              customer['PHONE'] = (customer.oPhone && customer.oPhone.sPrefixLandline ? customer.oPhone.sPrefixLandline : '') + (customer.oPhone && customer.oPhone.sLandLine ? customer.oPhone.sLandLine : '') + (customer.oPhone && customer.oPhone.sLandLine && customer.oPhone.sMobile ? ' / ' : '') + (customer.oPhone && customer.oPhone.sPrefixMobile ? customer.oPhone.sPrefixMobile : '') + (customer.oPhone && customer.oPhone.sMobile ? customer.oPhone.sMobile : '');
            }
      ...
      this.dialogService.openModal(CustomerAddressDialogComponent, { cssClass:"modal-lg", context: {iChosenCustomerId:this.iChosenCustomerId, mode: 'create', customerData: customer, editProfile: true } }).instance.close.subscribe(data =>{
       ...
       this.requestParams = {
        ...
        if(isIndex != -1){
          ...
          this.allcustomer[isIndex]['PHONE'] =(data?.customer?.data?.oPhone && data?.customer?.data?.oPhone.sPrefixLandline ? data?.customer?.data?.oPhone.sPrefixLandline : '') + (data?.customer?.data?.oPhone && data?.customer?.data?.oPhone.sLandLine ? data?.customer?.data?.oPhone.sLandLine : '') + (data?.customer?.data?.oPhone && data?.customer?.data?.oPhone.sLandLine && data?.customer?.data?.oPhone.sMobile ? ' / ' : '') + (data?.customer?.data?.oPhone && data?.customer?.data?.oPhone.sPrefixMobile ? data?.customer?.data?.oPhone.sPrefixMobile : '') +  (data?.customer?.data?.oPhone && data?.customer?.data?.oPhone.sMobile ? data?.customer?.data?.oPhone.sMobile : '')
        }
     });
